      ...
      <div>
        ...
        <Form>
          ...
          <FormGroup>
            ...
            <select id="user" name="buyer" onChange={this.handleChange}>
              <option value="default" hidden>
                Buyer
              </option>
              {userItems
                .filter((userItem) => userItem.id != this.props.auth.user.id)
                .map((filteredUserItem) => {
                  return (
                    <option value={filteredUserItem.id}>
                      {filteredUserItem.username}
                    </option>
                  );
                })}
            </select>
          ...
          <FormGroup>
            ...
            {/* TODO: More elegant way to get a space between label and input*/}
            <input
              type="number"
        ...
        <ModalFooter>
          <Button
            color="success"
            onClick={() => onSave(this.state.activeTransaction)}
          >
            Finish sale
          </Button>
        </ModalFooter>
