          ...
          <ol>
              {
                  this.state.persons
                    .map(person =>
                        <div> 
                        <li key={person.id}> <h3>Brukernavn: {person.username}</h3></li>
                        <ul>
                            <li> <h3>Navn: {person.name}</h3></li>
                            <li> <h3>E-post: {person.email}</h3></li>
                            <li> <h3>Logget inn: {String(person.has_logged_in)}</h3></li>
                        </ul>
                        </div>
                        )
              }
